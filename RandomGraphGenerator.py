...
class RandomGraphGenerator(object):
    ...
    def random_regular_graph(self, d, n, seed=None):
        """Returns a random `d`-regular graph on `n` nodex.
        ...
        Kim et al, 2003 shows that this algorithm have
        asymptotically complexity of aproximately O(n^{1/3})
        ...
        .. [2] Jeong Han Kim and Van H. Vu,
           ...
           Proceedings of the thirty-fifth ACM
            ...
            while stubs:
                ...
                for s1, s2 in zip(stubiter, stubiter):
                    ...
                    if s1 != s2 and ((s1, s2) not in edges):
                        ...
                        edges.add(
                            (s1, s2, abs((s1 - s2) << random.randint(7, 11))))
